...
//                     calendar에 시간 셋팅
    ...
    public void addFriends(View v) {
        FragmentManager fragmentManager = getSupportFragmentManager();
        FragmentTransaction fragmentTransaction = fragmentManager.beginTransaction();
        fragmentTransaction.setCustomAnimations(R.anim.left_in, R.anim.right_out).add(R.id.containerMain, new AddFriendsFragment(this), "AddFriendsFragment").addToBackStack(null).commit();
        drawer.closeDrawers();
    }
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.item_today_fortune:
                clickedItem = "메인 오늘의운세 클릭";clickable_item="clickable_item";
                track_item_clicked();
                fragmentTransaction.setCustomAnimations(R.anim.left_in, R.anim.right_out).add(R.id.containerMain, new TodayFortuneSelectFragment(activity), "TodayFortuneSelectFragment").addToBackStack(null)
                        .commit();
                break;
            ...
            case R.id.item_today_tail_fortune:
                clickedItem = "메인 띠별운세 클릭";clickable_item="clickable_item";
                track_item_clicked();
            ...
            case R.id.item_year_fortune:
                clickedItem = "메인 신년운세 클릭";clickable_item="clickable_item";
                track_item_clicked();
                pref.setIsBack(false);
            ...
            case R.id.item_gold_fortune:
                clickedItem = "메인 재물운 클릭";clickable_item="clickable_item";
                track_item_clicked();
                pref.setIsBack(false);
            ...
            case R.id.item_love_fortune:
                clickedItem = "메인 궁합 클릭";clickable_item="clickable_item";
                track_item_clicked();
...
//                fragmentTransaction.setCustomAnimations(R.anim.left_in,R.anim.right_out).add(R.id.containerMain, new CompatibilityFragment(activity)).addToBackStack(null).commit();
            ...
            case R.id.item_tojung_fortune:
                clickedItem = "메인 토정비결 클릭";clickable_item="clickable_item";
                track_item_clicked();
                pref.setIsBack(false);
