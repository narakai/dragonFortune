...
import com.jeycorp.dragonFortune.param.PutCompatibilityParam;
import com.jeycorp.dragonFortune.param.PutScoreParam;
import com.jeycorp.dragonFortune.result.GetCompatibilityResult;
import com.jeycorp.dragonFortune.result.GetCompatibilityResult;
 ...
 */
public class CompatibilityOutlineFragment extends Fragment implements View.OnClickListener {
    private View view;
    ...
    public CompatibilityOutlineFragment() {
        // Required empty public constructor
    }

    public CompatibilityOutlineFragment(ResultActivity activity) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_compatibility_outline,null);
        ...
        pref6 = new PreferenceManager6(getContext());
...
//        공유하기
        final ScrollView scrollView= view.findViewById(R.id.ScrollView1);
                ...
                @Override
                    public void onClick(View v) {
                    activity.clickedItem="궁합 공유하기 클릭"; activity.clickable_item="clickable_item";
    ...
    public void setText() {
        PutCompatibilityParam putCompatibilityParam = new PutCompatibilityParam();
        putCompatibilityParam.setName(pref.getName());
        putCompatibilityParam.setSex(pref.getSex());
        putCompatibilityParam.setSolunar(pref.getSolunar());
        putCompatibilityParam.setYear(pref.getYear());
        putCompatibilityParam.setMonth(pref.getMonth());
        putCompatibilityParam.setDay(pref.getDay());
        putCompatibilityParam.setHour(pref.getHour());
        putCompatibilityParam.setMin(pref.getMin());

        putCompatibilityParam.setYourName(pref6.getName());
        putCompatibilityParam.setYourSolunar(pref6.getSolunar());
        putCompatibilityParam.setYourYear(pref6.getYear());
        putCompatibilityParam.setYourMonth(pref6.getMonth());
        putCompatibilityParam.setYourDay(pref6.getDay());
        putCompatibilityParam.setYourHour(pref6.getHour());
        putCompatibilityParam.setYourMin(pref6.getMin());

        VolleyJsonHelper<PutCompatibilityParam, GetCompatibilityResult> setTextHelper = new VolleyJsonHelper<PutCompatibilityParam, GetCompatibilityResult>(getActivity());
        setTextHelper.request(UrlDefine.API_SET_COMPA_FORTUNE_OUTLINE, putCompatibilityParam, GetCompatibilityResult.class, setTextHelperListener, false, false, false);

    }

    private VolleyJsonHelper.VolleyJsonHelperListener<PutCompatibilityParam, GetCompatibilityResult> setTextHelperListener = new VolleyJsonHelper.VolleyJsonHelperListener<PutCompatibilityParam, GetCompatibilityResult>() {
        @Override
        public void onSuccess(PutCompatibilityParam putCompatibilityParam, GetCompatibilityResult getCompatibilityResult) {
...
//            txtToday.setText(str_date);
            ...
            TextView txtCompa1 = view.findViewById(R.id.txtCompa1);
            TextView txtCompa2 = view.findViewById(R.id.txtCompa2);
            TextView txtCompa3 = view.findViewById(R.id.txtCompa3);
            TextView txtCompa4 = view.findViewById(R.id.txtCompa4);
            TextView txtCompa5 = view.findViewById(R.id.txtCompa5);

            txtCompa1.setText(getCompatibilityResult.getG022());
            txtCompa2.setText(getCompatibilityResult.getG023());
            txtCompa3.setText(getCompatibilityResult.getG024());
            txtCompa4.setText(getCompatibilityResult.getT010());
            txtCompa5.setText(getCompatibilityResult.getY001());

        }

        @Override
        public void onMessage(PutCompatibilityParam putCompatibilityParam, GetCompatibilityResult getCompatibilityResult) {

        }

        @Override
        public void onError(PutCompatibilityParam putCompatibilityParam, VolleyError error) {
