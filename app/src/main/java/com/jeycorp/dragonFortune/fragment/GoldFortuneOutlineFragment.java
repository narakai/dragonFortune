...
import com.jeycorp.dragonFortune.result.GetGoldFortuneResult;
 ...
 */
public class GoldFortuneOutlineFragment extends Fragment implements View.OnClickListener {
    private View view;
    private PreferenceManager pref;
    private TextView txtUserName,txtUserBio,txtBirth,txtMoonSun,txtScore,txtBornGold,txtgoldNature,goldGather,goldLoss,textInvest,txtRecenGold;


    private ResultActivity activity;

    public GoldFortuneOutlineFragment(ResultActivity activity) {
        this.activity=activity;
        // Required empty public constructor
    }

    public GoldFortuneOutlineFragment() {
        // Required empty public constructor
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_gold_fortune_outline,null);
        ...
        txtBornGold = view.findViewById(R.id.txtBornGold);
        ...
        sharebutton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                activity.clickedItem="재물운 공유하기 클릭";
    ...
    public void setText() {
        ...
        VolleyJsonHelper<PutScoreParam, GetGoldFortuneResult> setTextHelper = new VolleyJsonHelper<PutScoreParam, GetGoldFortuneResult>(getActivity());
        setTextHelper.request(UrlDefine.API_SET_GOLD_FORTUNE_OUTLINE, putScoreParam, GetGoldFortuneResult.class, setTextHelperListener, false, false, false);

    }

    private VolleyJsonHelper.VolleyJsonHelperListener<PutScoreParam, GetGoldFortuneResult> setTextHelperListener = new VolleyJsonHelper.VolleyJsonHelperListener<PutScoreParam, GetGoldFortuneResult>() {
        @Override
        public void onSuccess(PutScoreParam putScoreParam, GetGoldFortuneResult getGoldFortuneResult) {
            ...
            txtScore.setText(getGoldFortuneResult.getLuck()+"0");

            txtBornGold.setText(getGoldFortuneResult.getS027());
            txtgoldNature.setText(getGoldFortuneResult.getS082());
            goldGather.setText(getGoldFortuneResult.getS116());
            goldLoss.setText(getGoldFortuneResult.getS117());
            textInvest.setText(getGoldFortuneResult.getS118());
            txtRecenGold .setText(getGoldFortuneResult.getS042());
        }

        @Override
        public void onMessage(PutScoreParam putScoreParam, GetGoldFortuneResult getGoldFortuneResult) {
