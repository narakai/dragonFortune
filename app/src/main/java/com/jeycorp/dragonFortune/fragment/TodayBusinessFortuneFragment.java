 ...
 */
public class TodayBusinessFortuneFragment extends Fragment implements View.OnClickListener {
    private View view;
    ...
    public TodayBusinessFortuneFragment(ResultActivity activity) {
        this.activity=activity;
        // Required empty public constructor
    }

    public TodayBusinessFortuneFragment() {
        // Required empty public constructor
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_today_business_fortune,null);
     ...
     ;
        ...
        sharebutton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                activity.clickedItem="사업운 공유하기 클릭";
