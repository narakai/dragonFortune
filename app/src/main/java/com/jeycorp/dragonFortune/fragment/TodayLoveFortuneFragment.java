 ...
 */
public class TodayLoveFortuneFragment extends Fragment implements View.OnClickListener {
    private View view;
    ...
    public TodayLoveFortuneFragment(ResultActivity activity) {
    ...
    public TodayLoveFortuneFragment() {
        // Required empty public constructor
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_today_love_fortune,null);
     ...
     ;
        ...
        sharebutton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                activity.clickedItem="오늘의 애정운 공유하기 클릭";activity.clickable_item="clickable_item";
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.item_today_fortune:
                activity.clickedItem="하단바 하단바 오늘의 운세 클릭";activity.clickable_item="clickable_item";
                activity.track_item_clicked();
                pref.setIsBack(true);
            ...
            case R.id.item_gold_fortune:
                activity.clickedItem="하단바 하단바 재물운 클릭";activity.clickable_item="clickable_item";
                activity.track_item_clicked();
            ...
            case R.id.item_love_fortune:
                activity.clickedItem="하단바 하단바 궁합 클릭";activity.clickable_item="clickable_item";
                activity.track_item_clicked();
            ...
            case R.id.item_tojung_fortune:
                activity.clickedItem="하단바 하단바 토정비결 클릭";activity.clickable_item="clickable_item";
                activity.track_item_clicked();
            ...
            case R.id.item_today_tail_fortune:
                activity.clickedItem="하단바 하단바 띠별운세 클릭";activity.clickable_item="clickable_item";
                activity.track_item_clicked();
                pref.setIsBack(true);
