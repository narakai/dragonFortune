 ...
 */
public class YearFortuneOutlineFragment extends Fragment implements View.OnClickListener{
    private View view;
    private PreferenceManager pref;
    private TextView txtUserName,txtUserBio,txtBirth,txtMoonSun,txtScore,txtYearOutline,txtYearBusiness,txtLove,txtHealth
            ,txtYearTrip,txtWork,txtGoldNature,goldGather,goldLoss,textInvest,txtRecenGold;
    private ResultActivity activity;




    public YearFortuneOutlineFragment() {
        // Required empty public constructor
    }

    public YearFortuneOutlineFragment(ResultActivity activity) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_year_fortune_outline,null);
        ...
        txtYearOutline=view.findViewById(R.id.txtYearOutline);
        txtYearBusiness=view.findViewById(R.id.txtYearBusiness);
        txtLove=view.findViewById(R.id.txtLove);
        txtHealth=view.findViewById(R.id.txtHealth);
        txtYearTrip=view.findViewById(R.id.txtYearTrip);
        ...
        sharebutton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                activity.clickedItem="신년운세 공유하기 클릭";activity.clickable_item="clickable_item";
    ...
    public void setText() {
        ...
        VolleyJsonHelper<PutScoreParam, GetYearFortuneResult> setTextHelper = new VolleyJsonHelper<PutScoreParam, GetYearFortuneResult>(getActivity());
        setTextHelper.request(UrlDefine.API_SET_YEAR_FORTUNE_OUTLINE, putScoreParam, GetYearFortuneResult.class, setTextHelperListener, false, false, false);

    }

    private VolleyJsonHelper.VolleyJsonHelperListener<PutScoreParam, GetYearFortuneResult> setTextHelperListener = new VolleyJsonHelper.VolleyJsonHelperListener<PutScoreParam, GetYearFortuneResult>() {
        @Override
        public void onSuccess(PutScoreParam putScoreParam, GetYearFortuneResult getYearFortuneResult) {
            txtUserName.setText(pref.getName());
            Log.e("성별",""+pref.getSex());
            ...
            txtScore.setText(getYearFortuneResult.getLuck()+"0");

            txtYearOutline.setText(getYearFortuneResult.getS104());
            txtYearBusiness.setText(getYearFortuneResult.getS095());
            txtLove.setText(getYearFortuneResult.getS097());
            txtHealth.setText(getYearFortuneResult.getS098());
            txtYearTrip.setText(getYearFortuneResult.getS099());
            txtWork.setText(getYearFortuneResult.getS100());
            txtGoldNature.setText(getYearFortuneResult.getS082());
            goldGather.setText(getYearFortuneResult.getS116());
            goldLoss.setText(getYearFortuneResult.getS117());
            textInvest.setText(getYearFortuneResult.getS118());
            txtRecenGold.setText(getYearFortuneResult.getS042());
        }

        @Override
        public void onMessage(PutScoreParam putScoreParam, GetYearFortuneResult getYearFortuneResult) {
            Log.e("또왜안되노","아");
